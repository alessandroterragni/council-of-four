...
/**
 * Represents an event message containing the execution of the closure of the buy-phase of the
 * bazaar turn.
 * @author Marco
 *
 */
public class EndBuyTurnEventMsg extends EventMsg {

	private static final long serialVersionUID = 5292693020770008930L;
	private String string;
	
	/**
	 * The constructor of the class, creates a new EndBuyTurnEventMsg.
	 ...
	 */
	public EndBuyTurnEventMsg(PlayerID currentPlayer, String string){
